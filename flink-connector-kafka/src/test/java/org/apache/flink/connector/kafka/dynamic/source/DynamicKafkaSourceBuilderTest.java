...
class DynamicKafkaSourceBuilderTest {
    ...
    @Test
    void testAutoOffsetResetIsNotDerivedFromInitializerStrategy() throws Exception {
        assertThat(
    ...
    @Test
    void testAutoOffsetResetExplicitPropertyIsPreservedWithDifferentInitializerStrategy()
            throws Exception {
        assertThat(
                        extractProperties(
                                        baseBuilder()
